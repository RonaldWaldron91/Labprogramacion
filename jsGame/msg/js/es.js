...
Blockly.Msg.ADD_ARG = "Agregar Argumento";
Blockly.Msg.ADD_ARGS = "Agregar Argumentos";
Blockly.Msg.ADD_COMMENT = "Añadir comentario";
Blockly.Msg.ANALOG_READ = "Lectura Analogica";
Blockly.Msg.ANALOG_WRITE = "Escritura Analogica";
Blockly.Msg.ANGLE = " angulo";
Blockly.Msg.ARCOIRIS = "Arcoiris";
Blockly.Msg.AUTH = "Autoriza a esta aplicación para guardar tu trabajo y permitir que lo compartas.";
Blockly.Msg.BLACK = "NEGRO";
Blockly.Msg.BLINK = "Parpadeo ";
Blockly.Msg.BOOLEAN = "logico";
Blockly.Msg.BOOLEANO = "Logico";
Blockly.Msg.BY = "por";
Blockly.Msg.CHANGE_VALUE_TITLE = "Cambiar el valor:";
Blockly.Msg.CHAR = "caracter";
Blockly.Msg.CHAT = "¡Chatea con tu colaborador escribiendo en este cuadro!";
Blockly.Msg.CLEAN_UP = "Limpiar los bloques";
Blockly.Msg.CLICKDER = "Click_Derecho";
Blockly.Msg.CLICKIZQ = "Click_Izquierdo";
Blockly.Msg.CLICKMID = "Click_Medio";
...
Blockly.Msg.COMENTARIO = "Comentario";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL = "https://github.com/google/blockly/wiki/Loops#loop-termination-blocks";  // untranslated
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "romper este bucle";
...
Blockly.Msg.CONTROLS_REPEAT_TITLE = "Repetir por %1 veces";
...
Blockly.Msg.COUNTER = "Contador";
Blockly.Msg.CUMPLEANOS = "Cumpleaños";
Blockly.Msg.DECLARACIONES = "Declaraciones   ";
Blockly.Msg.DECR_CONT = "Decrementar";
Blockly.Msg.DELAY = "Esperar";
Blockly.Msg.DELETE_BLOCK = "Eliminar bloque";
Blockly.Msg.DELETE_X_BLOCKS = "Eliminar %1 bloques";
Blockly.Msg.DER = "Der";
Blockly.Msg.DIFFERENTTO = "Diferente a";
Blockly.Msg.DIGITAL_READ = "Lectura Digital";
Blockly.Msg.DIGITAL_WRITE = "Escritura Digital";
Blockly.Msg.DISABLE_BLOCK = "Desactivar bloque";
Blockly.Msg.DUPLICATE_BLOCK = "Duplicar";
Blockly.Msg.DURACION = "duracion";
Blockly.Msg.EJE_X = "eje x";
Blockly.Msg.EJE_Y = "eje y";
Blockly.Msg.ENABLE_BLOCK = "Activar bloque";
Blockly.Msg.EQUALTO = "Igual a";
Blockly.Msg.EXPAND_ALL = "Expandir bloques";
Blockly.Msg.EXPAND_BLOCK = "Expandir bloque";
Blockly.Msg.EXTERNAL_INPUTS = "Entradas externas";
Blockly.Msg.FIN_CODE_PYGMO = "       Fin";
Blockly.Msg.FLOAT = "flotante";
Blockly.Msg.FOR = "Repetir para";
Blockly.Msg.FOREVER = "Por Siempre                                  ";
Blockly.Msg.FORWARD = "ADELANTE";
Blockly.Msg.FRECUENCY = "frecuencia";
Blockly.Msg.FROM = "desde";
Blockly.Msg.FUNCTION = "Funcion";
Blockly.Msg.FUNCTIONWIHTRETURN = "Funcion con retorno";
Blockly.Msg.GOFORWARD = "Ir hacia Adelante ";
Blockly.Msg.GOREVERSE = "Ir en Reversa ";
Blockly.Msg.GREATEROREQUAL = "Mayor o Igual a";
Blockly.Msg.GREATERTHAN = "Mayor que";
Blockly.Msg.HELP = "Ayuda";
Blockly.Msg.HIGH = "ALTO";
Blockly.Msg.INCR_CONT = "Incrementar";
Blockly.Msg.INICIO_CODE = "Inicio del Programa";
Blockly.Msg.INLINE_INPUTS = "Entradas en línea";
Blockly.Msg.INPUT = "ENTRADA";
Blockly.Msg.INPUT_PULLUP = "ENTRADA ALTA";
Blockly.Msg.INT = "entero";
Blockly.Msg.INVERTIR = "Invertir movimiento";
Blockly.Msg.IZQ = "Izq";
Blockly.Msg.KEYBOARD_BEGIN = "Iniciar Teclado";
Blockly.Msg.KEYBOARD_PRINT = "Imprimir en Teclado";
Blockly.Msg.KEYBOARD_TEXT = "Escribir una tecla";
Blockly.Msg.LEDOFF = "Apagar LED";
Blockly.Msg.LEDON = "Encender LED";
Blockly.Msg.LENGTH = "tamaño";
Blockly.Msg.LESSOEQUAL = "Menor o igual a";
Blockly.Msg.LESSTHAN = "Menor que";
Blockly.Msg.LIBRERIA = "Libreria";
Blockly.Msg.LIBRERIA_TEXT = "Escribe el nombre de la libreria";
Blockly.Msg.LINEA_CODIGO = "Linea de Codigo";
Blockly.Msg.LINECOMPARE = "Comparar Linea";
Blockly.Msg.LINEREAD = "Leer la Linea";
...
Blockly.Msg.ME = "Yo";
Blockly.Msg.MICROSEGUNDOS = "microsegundos";
Blockly.Msg.MILISEGUNDOS = "milisegundos";
Blockly.Msg.MILLIS = "Milisegundos transcurridos";
Blockly.Msg.MODE = "modo";
Blockly.Msg.MOTORS_OFF = "Apagar Motores ";
Blockly.Msg.MOTOR_OFF = "Apagar Motor";
Blockly.Msg.MOTOR_ON = "Encender Motor";
Blockly.Msg.MOTOR_SPEED = "Velocidad del Motor";
Blockly.Msg.MOUSE_BEGIN = "Iniciar Mouse";
Blockly.Msg.MOUSE_MOVE = "Mover Mouse";
Blockly.Msg.NAMEINIT = "nombre";
Blockly.Msg.NAVIDAD = "Navidad";
Blockly.Msg.NEW_VARIABLE = "Variable nueva…";
Blockly.Msg.NEW_VARIABLE_TITLE = "Nombre de variable nueva:";
Blockly.Msg.NOTA = "nota";
Blockly.Msg.NO_TONE = "No_tono";
Blockly.Msg.NUMERIC = "Numero";
Blockly.Msg.ORDINAL_NUMBER_SUFFIX = "";  // untranslated
Blockly.Msg.OUTPUT = "SALIDA";
Blockly.Msg.OWNCODE = "Escribe tu propio Codigo";
Blockly.Msg.PINMODE = "Modo del pin";
Blockly.Msg.PIROGAMES = "Juegos Pirotecnicos";
Blockly.Msg.POLICIA = "Policia";
...
Blockly.Msg.PULSEIN = "Pulso de entrada";
Blockly.Msg.PYGMO_BLACK = "Negra";
Blockly.Msg.PYGMO_CIRCLE = "Circulo";
Blockly.Msg.PYGMO_DERECHO = " derecho";
Blockly.Msg.PYGMO_DO = "Hacer";
Blockly.Msg.PYGMO_ElSE = "Else";  // untranslated
Blockly.Msg.PYGMO_FOLLOWER = "Seguir linea";
Blockly.Msg.PYGMO_FORWARD = "Adelante";
Blockly.Msg.PYGMO_HIGH = "Alta";
Blockly.Msg.PYGMO_INTERSECCION = "Si encuentra intersección color  ";
Blockly.Msg.PYGMO_LEFT = "Izquierda";
Blockly.Msg.PYGMO_LIGHTFOLLOWER = "Seguidor de luz - Rango";
Blockly.Msg.PYGMO_LIGHTIF = "Si sensor de luz izquierdo";
Blockly.Msg.PYGMO_LOW = "Baja";
Blockly.Msg.PYGMO_MEDIUM = "Media";
Blockly.Msg.PYGMO_MOVE = "Mover";
Blockly.Msg.PYGMO_OBSTACULO = "Si hay un obstaculo a ";
Blockly.Msg.PYGMO_REVERSE = "Atras";
Blockly.Msg.PYGMO_RIGHT = "Derecha";
Blockly.Msg.PYGMO_SECONDS = " segundo(s)";
Blockly.Msg.PYGMO_SKATE = "Serpiente  ";
Blockly.Msg.PYGMO_SPEED = "Velocidad";
Blockly.Msg.PYGMO_SPEEDBLOCK = "Velocidad de Motor izquierdo";
Blockly.Msg.PYGMO_STEPS = "Cantidad de veces  ";
Blockly.Msg.PYGMO_STOP = "Detenerse";
Blockly.Msg.PYGMO_TIME = "Tiempo";
Blockly.Msg.PYGMO_TIMES = " veces";
Blockly.Msg.PYGMO_TURN = "Girar hacia ";
Blockly.Msg.PYGMO_WAIT = "Esperar";
Blockly.Msg.PYGMO_WHITE = "Blanca";
Blockly.Msg.RACE = "Carrera";
Blockly.Msg.RANGO = "rango";
...
Blockly.Msg.RETURN = "Retorno";
Blockly.Msg.REVERSE = "REVERSA";
Blockly.Msg.SENSORREAD = "Leer Sensor";
Blockly.Msg.SERIAL_AVAILABLE = "Bytes disponibles en Serial";
Blockly.Msg.SERIAL_BEGIN = "Iniciar Serial ";
Blockly.Msg.SERIAL_PRINT = "Imprimir Serial";
Blockly.Msg.SERIAL_READ = "Leer Serial ";
Blockly.Msg.SET = "Establecer";
Blockly.Msg.SET_UP = "Configuraciones";
Blockly.Msg.SPEED = "velocidad";
Blockly.Msg.STRING = "cadena";
...
Blockly.Msg.TONE = "Tono";
Blockly.Msg.TOOLTIP_ANALOGREAD = "Chequear el estado de un pin analogico";
Blockly.Msg.TOOLTIP_ANALOGWRITE = "Hacer uso del PWM de la tarjeta";
Blockly.Msg.TOOLTIP_BOOLEAN = "Escribir true/false";
Blockly.Msg.TOOLTIP_CHAR = "Escribir un unico caracter";
Blockly.Msg.TOOLTIP_COMENTARIO = "Escribe un comentario";
Blockly.Msg.TOOLTIP_COUNTERDECLARATION = "Declarar un contador";
Blockly.Msg.TOOLTIP_DECLARARVECTOR = "Ingresa el tamaño del vector";
Blockly.Msg.TOOLTIP_DECRCOUNTER = "Decrementar el valor de la variable";
Blockly.Msg.TOOLTIP_DELAY = "Pausar el programa por un determinado tiempo en ms";
Blockly.Msg.TOOLTIP_DIGITALREAD = "Chequear el estado de un pin digital";
Blockly.Msg.TOOLTIP_DIGITALWRITE = "Escribir en un pin digital un HIGH o LOW";
Blockly.Msg.TOOLTIP_ESPECIALCODIGO = "Presiona en el espacio para ingresar un codigo manualmente";
Blockly.Msg.TOOLTIP_FUNCIONCONRETURN = "Declara una funcion con retorno.Presiona en el icono para agregar Argumentos";
Blockly.Msg.TOOLTIP_FUNCIONSINRETURN = "Declara una funcion sin retorno.Presiona en el icono para agregar Argumentos";
Blockly.Msg.TOOLTIP_GETFUNCTION = "Usar una determinada funcion antes declarada sin retorno";
Blockly.Msg.TOOLTIP_GETVAR = "Invocar variable";
Blockly.Msg.TOOLTIP_GETVECTOR = "Ingresa la posicion de la cual quieres obtener el valor guardado";
Blockly.Msg.TOOLTIP_GOFORWARD = "Encender dos motores hacia adelante";
Blockly.Msg.TOOLTIP_GOREVERSE = "Encender dos motores en reversa";
Blockly.Msg.TOOLTIP_INCRCOUNTER = "Incrementar el valor de la variable";
Blockly.Msg.TOOLTIP_INICIALIZARVECTOR = "Ingresa los valores iniciales del vector. Presione en el boton para agregar mas argumentos";
Blockly.Msg.TOOLTIP_KEYBOARDBEGIN = "Enviar una tecla";
Blockly.Msg.TOOLTIP_KEYBOARDINIT = "Inicializar modo teclado";
Blockly.Msg.TOOLTIP_LIBRERIA = "Declara la librearia que necesites usar";
Blockly.Msg.TOOLTIP_LINEACODIGO = "Usa este bloque para ingresar una linea de codigo manualmente";
Blockly.Msg.TOOLTIP_LINECOMPARE = "Establecer el umbral de un sensor de linea, para decidir entre blanco o negro";
Blockly.Msg.TOOLTIP_LINEREAD = "Leer el estado del sensor de linea";
Blockly.Msg.TOOLTIP_MOTOROFF = "Apagar un motor";
Blockly.Msg.TOOLTIP_MOTORON = "Encender un motor";
Blockly.Msg.TOOLTIP_MOTORSOFF = "Apagar dos motores";
Blockly.Msg.TOOLTIP_MOTORSPEED = "Variar la velocidad del motor en un valor entre 0-100";
Blockly.Msg.TOOLTIP_MOUSEINIT = "Inicializar modo mouse";
Blockly.Msg.TOOLTIP_MOUSEMOVE = "Enviar coordenadas para mover mouse";
Blockly.Msg.TOOLTIP_NOTONE = "Apagar un tono antes generado";
Blockly.Msg.TOOLTIP_NUMERICVAR = "Usar un valor numerico";
Blockly.Msg.TOOLTIP_PARAMETRO = "Agregale argumentos a tus funciones";
Blockly.Msg.TOOLTIP_PINMODE = "Establecer el comportamiento de un pin Entrada/Salida";
Blockly.Msg.TOOLTIP_SENSORREAD = "Saber el estado del sensor de linea de forma analogica";
Blockly.Msg.TOOLTIP_SERIALAVAILABLE = "Retorna el numero de bytes disponibles para leer";
Blockly.Msg.TOOLTIP_SERIALBEGIN = "Inicializar la comunicacion serial";
Blockly.Msg.TOOLTIP_SERIALPRINT = "Enviar un determinado valor via comunicacion serial";
Blockly.Msg.TOOLTIP_SERIALREAD = "Leer el primer byte que se encuentra disponible";
Blockly.Msg.TOOLTIP_SETFUNCTION = "Usar una determinada funcion antes declarada sin retorno";
Blockly.Msg.TOOLTIP_SETVAR = "Modificar valor de variable";
Blockly.Msg.TOOLTIP_SETVECTOR = "Ingresa la posicion y  el valor que desea guardar alli";
Blockly.Msg.TOOLTIP_STRINGVAR = "Escribir una cadena/texto";
Blockly.Msg.TOOLTIP_TONE = "Generar un tono en un pin determinado a cierta frecuencia";
Blockly.Msg.TOOLTIP_TURNGHT = "El primer motor es el izquierdo y el segundo el derecho";
Blockly.Msg.TOOLTIP_TURNLEFT = "El primer motor es el izquierdo y el segundo el derecho";
Blockly.Msg.TOOLTIP_ULTRASOUNDREAD = "Leer el sensor de ultrasonido";
Blockly.Msg.TOOLTIP_VARDECLARATION = "Declarar una variable";
Blockly.Msg.TOOTTIP_CIRCLE = "Selecciona velocidad, direccion y tiempo";
Blockly.Msg.TURNOFF = "Apagar";
Blockly.Msg.TURN_LEFT = "Girar hacia la Izquierda";
Blockly.Msg.TURN_RIGHT = "Girar hacia la Derecha";
Blockly.Msg.TYPE = "tipo";
Blockly.Msg.ULTRASOUNDREAD = "Leer el ultraSonido";
...
Blockly.Msg.WHEEL = "rueda";
Blockly.Msg.WHITE = "BLANCO";
